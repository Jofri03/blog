	...
	<div class="container">
		<div class="columns">
			<div class="column col-6 col-gapless col-mx-auto col-ml-auto">
				...
				<input type="hidden" id="blogid" value="${ blog.id }" /> <input
					class="form-input" type="text" id="title" value="${ blog.title }" /><br />
				<textarea class="form-input" id="content" rows="30">${ blog.content }</textarea>
				<br />
